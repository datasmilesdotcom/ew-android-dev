...
public class RelatedCoursesHeader extends Item<ViewHolder> implements ExpandableItem {
    ...
    public RelatedCoursesHeader(String headerTitle, String subTitle) {
        this.headerTitle = headerTitle;
        this.subTitle = subTitle;
    }

    public RelatedCoursesHeader(long id, String headerTitle, String subTitle) {
        super(id);
        this.headerTitle = headerTitle;
        this.subTitle = subTitle;
    }

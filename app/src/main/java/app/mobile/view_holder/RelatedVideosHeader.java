...
public class RelatedVideosHeader extends Item<ViewHolder> implements ExpandableItem {
    ...
    public RelatedVideosHeader(String headerTitle, String subTitle) {
        this.headerTitle = headerTitle;
        this.subTitle = subTitle;
    }

    public RelatedVideosHeader(long id, String headerTitle, String subTitle) {
        super(id);
        this.headerTitle = headerTitle;
        this.subTitle = subTitle;
    }
